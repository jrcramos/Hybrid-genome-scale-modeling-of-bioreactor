    ...
    try
        for i=1:7 % rows
            ...
            for row=1:nrow %coolumns
                ...
                miny1=miny1-abs(mean([miny1 maxy1]))*1.3;maxy1=maxy1+abs(mean([miny1 maxy1]))*1.3;
...
%                 end
                ...
                if id<3 || id==20
                    text(min([ minx1])+xrange*0.75,min([miny1 ])+yrange*1.13,Names(id),'HorizontalAlignment','right','VerticalAlignment','top','FontSize',11,'FontName','Arial','FontWeight','bold')
                else
                    text(min([ minx1])+xrange*0.75,min([miny1 ])+yrange*1.05,Names(id),'HorizontalAlignment','right','VerticalAlignment','top','FontSize',11,'FontName','Arial','FontWeight','bold')
                end
